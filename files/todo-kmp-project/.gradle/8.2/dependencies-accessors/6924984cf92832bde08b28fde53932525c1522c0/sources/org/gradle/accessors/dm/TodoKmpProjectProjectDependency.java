...
@NonNullApi
public class TodoKmpProjectProjectDependency extends DelegatingProjectDependency {

    @Inject
    public TodoKmpProjectProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
     ...
     */
    public AndroidAppProjectDependency getAndroidApp() { return new AndroidAppProjectDependency(getFactory(), create(":android-app")); }
