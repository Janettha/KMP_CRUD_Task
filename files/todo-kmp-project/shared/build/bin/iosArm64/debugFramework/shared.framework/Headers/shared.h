...
@class SharedTask, SharedCreateTaskRequestCompanion, SharedCreateTaskRequest, SharedTaskCompanion, SharedTaskApi, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing;

@protocol SharedKotlinx_serialization_coreKSerializer, SharedKotlinx_coroutines_coreStateFlow, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKotlinx_coroutines_coreFlowCollector, SharedKotlinx_coroutines_coreFlow, SharedKotlinx_coroutines_coreSharedFlow, SharedKotlinIterator, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKotlinKClass, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier;
...
__attribute__((swift_name("TaskApi")))
@interface SharedTaskApi : SharedBase
...
*/
- (void)createTaskTitle:(NSString *)title description:(NSString *)description completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("createTask(title:description:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)deleteTaskId:(int64_t)id completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("deleteTask(id:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getTaskId:(int64_t)id completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("getTask(id:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getTasksWithCompletionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("getTasks(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)updateTaskId:(int64_t)id task:(SharedTask *)task completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("updateTask(id:task:completionHandler:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CreateTaskRequest")))
@interface SharedCreateTaskRequest : SharedBase
...
@property (class, readonly, getter=companion) SharedCreateTaskRequestCompanion *companion __attribute__((swift_name("companion")));
- (SharedCreateTaskRequest *)doCopyTitle:(NSString *)title description:(NSString *)description __attribute__((swift_name("doCopy(title:description:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CreateTaskRequest.Companion")))
@interface SharedCreateTaskRequestCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCreateTaskRequestCompanion *shared __attribute__((swift_name("shared")));
...
- (instancetype)initWithId:(int64_t)id title:(NSString *)title description:(NSString *)description completed:(BOOL)completed createdAt:(NSString *)createdAt __attribute__((swift_name("init(id:title:description:completed:createdAt:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedTaskCompanion *companion __attribute__((swift_name("companion")));
- (SharedTask *)doCopyId:(int64_t)id title:(NSString *)title description:(NSString *)description completed:(BOOL)completed createdAt:(NSString *)createdAt __attribute__((swift_name("doCopy(id:title:description:completed:createdAt:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Task.Companion")))
@interface SharedTaskCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedTaskCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TaskRepository")))
@interface SharedTaskRepository : SharedBase
- (instancetype)initWithApi:(SharedTaskApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)addTaskTitle:(NSString *)title description:(NSString *)description completionHandler:(void (^)(SharedBoolean * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("addTask(title:description:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)deleteTaskTaskId:(int64_t)taskId completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("deleteTask(taskId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)loadTasksWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("loadTasks(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)toggleTaskCompletionTaskId:(int64_t)taskId completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("toggleTaskCompletion(taskId:completionHandler:)")));
...
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> tasks __attribute__((swift_name("tasks")));
@end
